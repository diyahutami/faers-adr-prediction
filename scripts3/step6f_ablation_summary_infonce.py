...
def compile_summary(results_path: str) -> pd.DataFrame:
    ...
    for variant in ["xxx", "xxx_gender", "xxx_age"]:
        ...
        main = _load_json(os.path.join(out_dir, "final_metrics_infonce.json"))
        tm   = main.get("test_metrics", {})

        # ── 6.1 Data Volume ──────────────────────────────────────────────
        dv = _load_json(os.path.join(out_dir, "ablation_data_volume_infonce.json"))
        ...
        # ── 6.2 Contrastive ──────────────────────────────────────────────
        cl = _load_json(os.path.join(out_dir, "ablation_contrastive_infonce.json"))
        ...
        # ── 6.3 Demographic ──────────────────────────────────────────────
        dem = _load_json(os.path.join(out_dir, "ablation_demographic_infonce.json"))
        ...
        # ── 6.4 Graph Structure ───────────────────────────────────────────
        gs = _load_json(os.path.join(out_dir, "ablation_graph_structure_infonce.json"))
        ...
        # ── 6.5 Node Features ─────────────────────────────────────────────
        nf = _load_json(os.path.join(out_dir, "ablation_node_features_infonce.json"))
...
def main():
    ...
    # Save
    csv_path  = os.path.join(args.results_path, "ablation_summary_infonce.csv")
    json_path = os.path.join(args.results_path, "ablation_summary_infonce.json")
